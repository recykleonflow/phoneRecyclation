...
(function(global, factory) {
  ...
  Particles.prototype = {
    ...
    init: function() {
      ...
      this.canvas.style = "position: absolute;pointer-events: none;top: 50%;left: 50%;transform: translate3d(-50%,-50%,0);display:none;";
      this.wrapper = document.createElement("div");
      this.wrapper.className = "particles-wrapper";
      this.wrapper.style = "position: relative;display: inline-block;overflow: hidden;will-change: transform;";
      this.el.parentNode.insertBefore(this.wrapper, this.el);
      this.wrapper.appendChild(this.el);
      this.parentWrapper = document.createElement("div");
      this.parentWrapper.className = "particles";
      this.parentWrapper.style = "position: absolute;grid-area: 1 / 1 / 2 / 2;"
