...
export interface PhoneCardInterface extends utils.Interface {
  functions: {
    "addValidIpfsUrl(string)": FunctionFragment;
    ...
    "removeValidIpfsUrl(string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "addValidIpfsUrl",
  ...
  encodeFunctionData(
    functionFragment: "removeValidIpfsUrl",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface PhoneCard extends BaseContract {
